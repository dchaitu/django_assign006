...
class React(models.Model):
    ...
    reaction_type = models.CharField(choices=CHOICES,max_length=20)
    post = models.ForeignKey(Post,related_name="reacted_to_post" ,on_delete=models.CASCADE,blank=True, null=True)
    comment = models.ForeignKey(Comment,related_name="commented_to_the_post", on_delete=models.CASCADE,blank=True, null=True)
